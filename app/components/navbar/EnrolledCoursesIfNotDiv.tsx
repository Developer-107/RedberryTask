...
export default function EnrolledCoursesIfNotDiv() {
  return (
    <div className="flex flex-col h-full pb-[30vh] items-center justify-center gap-3">
      <svg
        width="130"
        height="132"
        viewBox="0 0 130 132"
      ...
      <div className="flex flex-col items-center">
        <p className="font-medium text-[#130E67] text-[24px]">
          No Enrolled Courses Yet
        </p>
        <p className="mt-1 font-medium text-[#130E67] text-[14px]">
          Your learning journey starts here!
        </p>
        <p className="font-medium text-[#130E67] text-[14px]">
