...
interface Props {
  courseTitle?: string;
  seatsNotAvailableWindowOpen?: (type: boolean) => void;
}

export default function SeatsNotAvailable({ courseTitle, seatsNotAvailableWindowOpen } : Props) {
  return (
      ...
      <div className="flex flex-col justify-center p-15 items-center gap-10 bg-white rounded-lg mb-[10vh]">
        <div className="flex flex-col gap-6 justify-center items-center text-gray-700">
          ...
          >
            ...
            />
            <path
              d="M47 72.9336C46.2738 72.9336 45.5639 72.7182 44.96 72.3148C44.3562 71.9113 43.8855 71.3378 43.6076 70.6669C43.3297 69.9959 43.257 69.2576 43.3987 68.5454C43.5404 67.8331 43.8901 67.1788 44.4036 66.6653C44.9171 66.1518 45.5714 65.8021 46.2837 65.6604C46.9959 65.5187 47.7342 65.5914 48.4052 65.8693C49.0761 66.1473 49.6496 66.6179 50.0531 67.2217C50.4565 67.8256 50.6719 68.5355 50.6719 69.2617C50.6719 70.2356 50.285 71.1695 49.5964 71.8581C48.9078 72.5467 47.9738 72.9336 47 72.9336Z"
              fill="#F4A316"
            />
          </svg>
          ...
          <p>
            Seats for <span className="font-medium">"{courseTitle}"</span> are not Available
          </p>
        </div>

        <button
          onClick={seatsNotAvailableWindowOpen && (() => seatsNotAvailableWindowOpen(false))}
