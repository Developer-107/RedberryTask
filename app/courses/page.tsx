...
export default function page() {
  ...
  const [metaData, setMetaData] = useState<MetaData>({currentPage: 1,
    lastPage: 1,
    perPage: 1,
    total: 1
  });
    ...
    <div className="flex flex-col mt-[69.5px] gap-8.5">
      ...
      <div className="grid grid-cols-4">
        ...
        <div className="flex flex-col text-gray-500 gap-4  pr-22.5">
          <hr />
          <p>{filters.categories.length + filters.instructors.length + filters.topics.length} Filters Active</p>
        ...
        <div className="col-span-3 flex flex-col gap-8">
          ...
          <div className="w-full flex justify-between items-center text-gray-500">
            <p>{metaData.total > 0 ? `Showing ${courses?.length || 0} out of ${metaData.total}` : "No courses found"} </p>
